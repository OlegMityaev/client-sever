// graph.hpp
// Структуры и функции для проверки графа и поиска кратчайшего пути.
// Реализует валидацию графа и алгоритм Беллмана-Форда для неориентированных графов.
...
struct ValidationResult {
    ...
    std::string message;    // Сообщение об ошибке (если ok == false)
};
